  ...
  return (
    ...
    >
      ...
      <div className="basis-full flex flex-col">
        ...
        <div className="basis-full flex flex-row mb-3">
          <Skeleton variant="rounded" width={"100%"} height={32} sx={{ mt: 2, mb: 2 }} />
        </div>
        <div className="basis-full flex flex-row flex-wrap mb-10">
          <Skeleton variant="rounded" width={"100%"} height={80} sx={{ mb: 2 }} />
          <Skeleton variant="rounded" width={"100%"} height={110} sx={{ mb: 2 }} />
        </div>
        <div className="basis-full flex flex-col mb-6">
        </div>
      </div>
    </div>
  );
